/* criar o Banco de dados  não roda no postgresql pq usa float*/
/* criar o Banco de dados  não roda no mysql pq usa boolean*/
create database cee 
...
num_saidas INT,
potencia INT,
tensao_min_por_entrada FLOAT,
tensao_max_por_entrada FLOAT,
corrente_min_por_entrada FLOAT,
corrente_max_por_entrada FLOAT,
tensao_min_saida FLOAT,
tensao_max_saida FLOAT,
corrente_min_saida FLOAT,
corrente_max_saida FLOAT,
